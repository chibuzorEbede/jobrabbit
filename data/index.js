...
const jobData = [
  {
    id: 1,
    imgUrl: "/company-icon.jfif",
    jobTitle: "senior ux developer",
    employerName: "AirBnB",
    jobLocation: "sacramento, california",
    employmentType: "temporary",
    jobPostDate: "posted 3 days ago",
    jobUrl: "/job/2",
  },
  {
    id: 2,
...
//parse json data and filter for the following properties
...
const jsonData = [
  ...
  },
  {
    ...
    job_benefits: null,
    job_google_link:
      "https://www.google.com/search?gl=us&hl=en&rciv=jb&q=web+developer+in+texas+usa&start=0&ibp=htl;jobs#fpstate=tldetail&htivrt=jobs&htiq=web+developer+in+texas+usa&htidocid=RmMWVIxJKacAAAAAAAAAAA%3D%3D",
  ...
  },
  {
    ...
    job_google_link:
      "https://www.google.com/search?gl=us&hl=en&rciv=jb&q=web+developer+in+texas+usa&start=0&ibp=htl;jobs#fpstate=tldetail&htivrt=jobs&htiq=web+developer+in+texas+usa&htidocid=uSveAal9k1IAAAAAAAAAAA%3D%3D",
    ...
    job_required_skills: ["JavaScript", "HTML", "CSS", "Frontend"],
    job_required_education: {
      postgraduate_degree: false,
      professional_certification: false,
      high_school: false,
  ...
  },
  {
    ...
    job_google_link:
      "https://www.google.com/search?gl=us&hl=en&rciv=jb&q=web+developer+in+texas+usa&start=0&ibp=htl;jobs#fpstate=tldetail&htivrt=jobs&htiq=web+developer+in+texas+usa&htidocid=9gZFCv-muG4AAAAAAAAAAA%3D%3D",
    job_offer_expiration_datetime_utc: "2023-11-29T00:00:00.000Z",
    job_offer_expiration_timestamp: 1701216000,
    job_required_experience: {
      no_experience_required: false,
    ...
    job_onet_job_zone: "4",
    job_occupational_categories: ["Computer Science"],
  ...
  },
  {
    ...
    job_google_link:
      "https://www.google.com/search?gl=us&hl=en&rciv=jb&q=web+developer+in+texas+usa&start=0&ibp=htl;jobs#fpstate=tldetail&htivrt=jobs&htiq=web+developer+in+texas+usa&htidocid=1lr1uWOWY3MAAAAAAAAAAA%3D%3D",
    job_offer_expiration_datetime_utc: null,
    job_offer_expiration_timestamp: null,
    job_required_experience: {
      no_experience_required: false,
...
function jobFilter(jsondata) {
  let newData = [];
  //   let fields = ['employer_name','employer_logo','job_employment_type','job_title']
  jsondata.forEach((data) => {
    let jobDetails = {};
    if (data.employer_name) {
      jobDetails.employerName = data.employer_name;
    }
    if (data.employer_logo) {
      jobDetails.imgUrl = data.employer_logo;
    }
    if (data.job_employment_type) {
      jobDetails.employmentType = data.job_employment_type;
    }
    if (data.job_title) {
      jobDetails.jobTitle = data.job_title;
    }
    if (data.job_country) {
      jobDetails.jobLocation = `${data.job_country},${data.job_state},${data.job_city} `;
    }
    if (data.job_offer_expiration_datetime_utc) {
      jobDetails.jobPostDate = data.job_offer_expiration_datetime_utc;
    }
    if (data.job_apply_link) {
      jobDetails.jobUrl = data.job_apply_link;
    }
...
const apiJob = jobFilter(jsonData);

module.exports = { jobs, candidates, jobData, jsonData, apiJob };
